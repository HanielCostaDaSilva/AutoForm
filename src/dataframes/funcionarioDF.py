...
situacao_lista = ["NAO CADASTRADO","CADASTRANDO","MUNICIPIO NAO ENCONTRADO","CADASTRADO"]
...
if os.path.exists(func_situacao_df_excel_path):
    ...
    func_situacao_df.loc[func_situacao_df['SITUACAO'] == '', 'SITUACAO'] = situacao_lista[0]
    ...
    #Adicionamos a coluna do codigo de municipio
    #func_situacao_df["CODIGO_MUNICIPIO"] = ""
