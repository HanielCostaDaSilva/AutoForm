...
for index, row in func_data_df.iterrows():
    ...
    situacao_check = func_situacao_df.loc[func_situacao_df["MATRICULA"]
                                          == row["MATRICULA"], "SITUACAO"]
    ...
    func_situacao_df.loc[func_situacao_df["MATRICULA"] ==
                         row["MATRICULA"], "SITUACAO"] = situacao_lista[1]
    ...
    try:
        ...
        func_situacao_df.loc[func_situacao_df["MATRICULA"] ==
                             row["MATRICULA"], "CODIGO_MUNICIPIO"] = municipio_encontrado.codigo
